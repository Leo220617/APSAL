...
namespace Sicsoft.Checkin.Web
{
    ...
    public static class CheckinServiceCollectionExtensions
    {
      ...
      .AddHttpMessageHandler<AuthenticatedHttpClientHandler>();
            ...
            services.AddRefitClient<ICrudApi<DiasViewModel, int>>()
      .ConfigureHttpClient(c => c.BaseAddress = new Uri($"{Configuration["UrlWebApi"]}/api/Dias"))
      .AddHttpMessageHandler<AuthenticatedHttpClientHandler>();


            services.AddRefitClient<ICrudApi<ComidasViewModel, int>>()
    .ConfigureHttpClient(c => c.BaseAddress = new Uri($"{Configuration["UrlWebApi"]}/api/Comidas"))
    .AddHttpMessageHandler<AuthenticatedHttpClientHandler>();
